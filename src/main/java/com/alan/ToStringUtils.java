...
import static com.alan.ToStringUtils.ToStringTokenUtils.splitToken;
...
public class ToStringUtils {
	...
	private static Map<Object, Object> buildMapValue(String value) throws ParseException {
		...
		while (StringUtils.isNotEmpty(token = splitToken(value))) {
			Pair<String, String> keyValue = ToStringTokenUtils.parseToken(token);
			result.put(buildTypeValue(keyValue.getKey(), keyValue.getKey()), buildTypeValue(keyValue.getValue(), keyValue.getValue()));
	...
	public static class ToStringTokenUtils {
		...
		static Pair<String, String> parseToken(String token) {
			...
			return new ImmutablePair<>(token.substring(0, index), token.substring(index + 1));
		}
	...
	public static void main(String[] args) {
		try {
			System.out.println(ToStringUtils.toJSONString("[CyyBuyerSeatPlanAndZoneConcreteInfoVO(bizSeatPlanId=674184b8b21b320001ee3e79, zoneConcreteInfos=[CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6d22, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6cc4, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6a25, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6d1d, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d68b0, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6d1f, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6d1e, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d68af, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6d50, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6a21, onsale=true, onsaleTicketCount=2), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6dc2, onsale=true, onsaleTicketCount=1), CyyBuyerSeatPlanAndZoneConcreteInfoVO.ZoneConcreteInfo(zoneConcreteId=674184b9a8a9a600010d6d21, onsale=true, onsaleTicketCount=5)])]]"));
			Map<String, Map<String, String>> stringMapMap = JSON.parseObject("{\"S0001\":{\"6350eae6df9a690001189a0a\":\"学生优惠\"}}", new TypeReference<Map<String, Map<String, String>>>() {
			});
			System.out.println(stringMapMap.get("S0001").get("6350eae6df9a690001189a0a"));
